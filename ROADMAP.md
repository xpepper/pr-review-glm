...
**Where we are:** I7 complete. **Next:** M1 — generic Copilot plugin marketplace (then I8 hardening → 1.0.0).
...
| I8 | ⬜ Pending | Hardening: large-diff file-backed transport (≥200 KB manifest + required read ranges), lane/credit telemetry from runtime events, dogfood-driven fixes. | M1 |
