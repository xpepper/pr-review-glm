...
**Where we are:** M1 complete. **Next:** V2 — ground-testing feedback round before the 1.0.0 release decision (I8 hardening landed 2026-09-14).
...
| V2 | ⬜ Pending | Ground-testing feedback round before the 1.0.0 release decision (user decision 2026-09-14: ground-test 0.2.6, collect feedback, fix what it surfaces — then the user calls the 1.0.0 bump): dogfood-driven fixes on real PRs, telemetry-informed budget tuning (the first loop-owned run's `phaseTimings.dogfood` confirms or tunes the 20m cap), riding P2s as they surface. Scope intentionally fluid; keep it small. | I8 |
